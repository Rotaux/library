...
public class ReaderTable extends Pane{
	...
	public void init(String sql) {
		...
		TableColumn<Map, String> c1 = new TableColumn<>("读者编号");
		TableColumn<Map, String> c2 = new TableColumn<>("读者姓名");
		TableColumn<Map, String> c3 = new TableColumn<>("性别");
		TableColumn<Map, String> c4 = new TableColumn<>("身份证号");
		TableColumn<Map, String> c5 = new TableColumn<>("办证日期");
		TableColumn<Map, String> c6 = new TableColumn<>("读者类型");
		TableColumn<Map, String> c7 = new TableColumn<>("联系电话");
		TableColumn<Map, String> c8 = new TableColumn<>("地址");
		TableColumn<Map, String> c9 = new TableColumn<>("密码");
		TableColumn<Map, String> c10 = new TableColumn<>("状态");
